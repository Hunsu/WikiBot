...
public class CanadianRatings {
	...
	for (String filename : files) {
		...
		title = "Saison 2 de Sleepy Hollow";
	...
	String s = "http://assets.numeris.ca/Downloads/";
	s += new DateFormatSymbols(Locale.ENGLISH).getMonths()[cal
		.get(Calendar.MONTH)] + "%20";
	s += cal.get(Calendar.DATE) + "-";
	cal.set(Calendar.DATE, cal.get(Calendar.DATE) + 6);
	s += cal.get(Calendar.DATE) + ",%20" + cal.get(Calendar.YEAR)
		+ "%20(National).pdf";
