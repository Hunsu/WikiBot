...
public class Series implements Serializable {
	...
	private HashMap<String, String> reccuringGuest;
	...
	public void setReccuringGuest(HashMap<String, String> reccuringGuest) {
		this.reccuringGuest = reccuringGuest;

	}
	public HashMap<String, String> getReccuringGuest(){
		return reccuringGuest;
	}
