...
public class Episode implements Serializable {
    ...
    private HashMap<String,String> guestStars = new HashMap<String,String>();
	...
	private String link;
	private List<String> teleplayWriters;
	private List<String> storyWriters;
    ...
    public HashMap<String, String> getGuestStars() {
        return guestStars;
    }
    ...
    public void setGuestStars(HashMap<String,String> guestStars) {
	...
	public void setTeleplayWriters(List<String> teleplayWriters) {
		this.teleplayWriters = teleplayWriters;

	}

	public List<String> getTeleplayWriters(){
		return teleplayWriters;
	}

	public void setStoryWriters(List<String> storyWriters) {
