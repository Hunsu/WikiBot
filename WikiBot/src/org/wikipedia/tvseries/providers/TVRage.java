...
public class TVRage {
    ...
    public Season getSeason(String serieName, String seasonNumber)
	    throws IOException {
	Season season = new Season(serieName, seasonNumber);
    ...
    private List<Episode> getEpisodesList(Document doc, String season) {
	List<Episode> episodes = new ArrayList<Episode>();
	...
	for (; iterator.hasNext();) {
	    ...
	    episode.setEpisodeName(e.text());
	    episode.setSeasonNumber(Integer.valueOf(season));
