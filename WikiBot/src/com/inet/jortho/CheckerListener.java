...
public class CheckerListener implements PopupMenuListener, LanguageChangeListener {
     ...
     *
     * @param menu a JMenu or JPopuup
     * @param options current spell checker options
     */
     ...
     *
     * @param jText current JTextComponent
     * @return the current position
     * @throws BadLocationException should never occur
     */
