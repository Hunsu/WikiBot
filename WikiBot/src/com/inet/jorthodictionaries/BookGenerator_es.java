...
public class BookGenerator_es extends BookGenerator {
    ...
    /**
     * Find rule and add words.
     *
     * @param word the word
     * @param wikiText the wiki text
     * @param rule the rule
     * @param endingName the ending name
     */
     ...
     * @param ending1 the ending1
     * @param ending2 the ending2
     * @param ending3 the ending3
     * @param ending4 the ending4
     */
